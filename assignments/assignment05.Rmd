...
In their working paper, [Kraft et al (2021)](https://www.edworkingpapers.com/ai21-441) examined an understudied area - the pathway through which mentoring relationship between students and school personnel influences human capital development. Particularly, they found that having a school-based mentor is associated with an increase of 0.24 GPA points at high-school, a full year of additional education, and an increase of $60,600-$92,400 in lifetime earnings. Inspired by their study, we step further and take interested in whether and to what extent having a school-based mentor earlier in their life is also related to these short- and long-term school outcomes. In this final project, we invite you to investigate two research questions, one from the questions 1-3 (using [ah01.csv dataset](./data/ah01.csv)) in Kraft et al paper and one from our further inquiries 4-6 (using [ah02.csv dataset](./data/ah02.csv)), listed below:

1. Whether and to what extent having a school-based mentor relates to participants' high school overall GPA?

2. Whether and to what extent having a school-based mentor relates to participants' total years of education?

3. Whether and to what extent having a school-based mentor relates to participants' participant annual earnings?

4. Whether and to what extent having a school-based mentor earlier in life relates to participants' high school overall GPA?

5. Whether and to what extent having a school-based mentor earlier in life relates to participants' total years of education?

6. Whether and to what extent having a school-based mentor earlier in life relates to participants' annual earnings?
...
Your final project should be delivered in two forms: (a) an R script that we can run without errors, and (b) a 2-3 paragraph write up of the analysis, results, and discussions of your research questions. This writeup should contain the following elements:
