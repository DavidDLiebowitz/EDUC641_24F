...
3.1.1. Using the mean and standard deviation of *vocabulary*, create a normal distribution plot (same type with the previous one) and add to your previous plot (note: set.seed(123) so we can get the same sample from the randomization). You may choose one of the two ways to do this: (a) use base R code to put the two plots side-by-side, or (b) use {ggplot2} package to put the two into one plot. 

3.1.2. What are the statistical meanings of this new plot?

3.1.3. Compare these two distributions and interpret what you have observed.

3.1.4. Despite whether *vocabulary* is normally distributed, you wand to assume normal distribution in your future analysis. At this point, please specify your null hypothesis and (2-tailed) alternative hypothesis for the single-samle t-test.

3.2 One-sample t-test

3.2.1 To test whether your null hypothesis is true, run a 
