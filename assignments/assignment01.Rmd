 ...
 * An .html or .pdf file that includes both - 
   ...
   + and the R code chunks that generated your answers (hint: if you choose to compose your answers in Rmarkdown, simply set up echo = TRUE, include = TRUE in you .Rmd file)  
...
2.2. Write your own code to transform the variables, *treat*, *absenteeism*, and *cgender* into factor variables and label them consistently with the data background information above. 
