...
Open your RStudio, create a project and save it to your local. Go to the root directory of the project and create a folder named "data". Download the [cat.csv dataset](./data/cat.csv) and store it in the folder "data". Create an Rmd/R file in the project root directory. To read the dataset into your Rmd/R file, use the code chunk below (it's important that you copy-paste the entire code):
...
5.1. We are insterested in whether the relationship between *treat* and *absenteeism* differ across girls and boys. What's the null hypothesis ($H_0$) that we should test? 
