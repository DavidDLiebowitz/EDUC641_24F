...
3.2. Calculate the Chi-squared statistic using the tables you generated in 2.1 and 3.2. In one sentence, state what this Chi-squared statistic represents. **(2 points)**
