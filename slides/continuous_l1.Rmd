...
Normally, we visualize boxplots vertically with groups plotted along the x-axis for comparison.
...
Which part of the boxplot do you notice changing the most from year-to-year?
