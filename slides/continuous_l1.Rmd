...
Add density plot, histrogram, and country plot
...
---
# SUMMATION NOTATION AS A SHORTHAND FOR MEAN CALCULATIONS
...
ADD DETAILS TO REFLECT WHO DATA HERE:
> $$\bar{X} = \frac{1}{191}{\sum_{i=i}^{n} X_{i}}$$
...
```{R}
country_plot +
  geom_vline(xintercept = mean(who$life_expectancy))
...
REWORD TO FOCUS ON TRANSFORMATIONS AND STANDARDIZING VALUES
...
DISCUSS THE MOTIVATION FOR STANDARDIZING DISTRIUBTION

DROP THE NORMAL PLOT
```{r echo=FALSE}
...
---
SLIDE ON HOW TRANSOFMRATIONS DON'T CHANGE SHAPE OF DISTRIBUTION
...
We do not need to know how to calculate skew and kurtosis but we need to have a sense of how to interpret them.
...
In this course we will focus visual analysis for severe skew or kurtosis. 

Future courses will discuss how to correct for skew or kurtosis, as necessary. 
...
---
# Other Vulnerabilities of Central Tendency Measures
