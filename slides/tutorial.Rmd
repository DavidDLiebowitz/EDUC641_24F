...
4. [Hands-on Activity (Week 1 Participation Point)](#activity)
...
3. Get to know your RStudio; open RStudion desktop and finish the hands-on activity (week 1 participation point attached)
...
Open your RStudio, run these below code in your console line-by-line, copy and paste the results in a word document, and submit the doc to Canvas to get the first week's participation point (deadline is before our first class meeting).
