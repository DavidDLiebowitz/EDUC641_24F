...
$$
\hat{LIFEEXPECTANCY} = 42.85 + 2.23 * \left( SCHOOLING \right)
$$
...
$$
\color{red}{\hat{LIFEEXPECTANCY}} = 42.85 + 2.23 * \left( SCHOOLING \right)
$$
...
$$
\hat{LIFEEXPECTANCY} = \color{red}{42.85} + 2.23 * \left( SCHOOLING \right)
$$
...
$$
\hat{LIFEEXPECTANCY} = 42.85 + \color{red}{2.23} * \left( SCHOOLING \right)
$$
...
$$
\hat{LIFEEXPECTANCY} = 42.85 + 2.23 * \left( \color{red}{SCHOOLING} \right)
$$
...
- Final assignment due **December 6** at 11:59PM
