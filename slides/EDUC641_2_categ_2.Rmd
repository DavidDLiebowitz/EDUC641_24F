...
```{r, echo=F, fig.height=5.5}
ggplot(chsq, aes(Chi_Square, ..density..)) + geom_density()
```
...
3. Summarize the observed data in relationship to an expected value
    + *We'll return to this more formally in the Continuous II unit to understand where these "expected" values come from*
4. Estimate the *p*-value
5. Reject or fail to reject the null hypothesis
6. Interpret your findings drawing explicitly on plots, summary statistics and test statistics
