...
```{r, out.width = "80%", echo=F}
  include_graphics(here("slides/Roadmap_1.png"))
```
...
## 2. Continuous: data with arithmetic properties
## 3. Ordinal: part label, part number
...
.pull-right[
```{r, echo=F}
include_graphics(here("slides/mccleskey.png"))
```
...
str(df)
```
> I'd like to be able to mark up this output to show Ss what each item represents
