...
.small[A distribution describes the number of observations of variable that take a particular value.]
...
```{r, echo = F, fig.height=5.25, fig.width=10, dpi = 600}
ggplot() +
  geom_label(data = d, 
             aes(x = x_mid,
                 y = y,
...
* If we take the square root of our sample variance, we can summarize average deviations back onto our raw scale. 
...
```{r, fig.height=3.25, fig.width=6, echo = T}
