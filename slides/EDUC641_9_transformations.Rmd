...
pacman::p_load(tidyverse, here, knitr, blogdown, rio, gridExtra, xaringanthemer)
...
### Response rate: 66 percent (23/35)
...
**Helpful:**
.small[
* Very well organized and high quality materials
* Application opportunities on quizzes and assignments
...
.small[
* More opportunities to access help
* Lack of clarity in grading of assignments
* More focus on learning R
* Facilities/projector issues
* Too basic/easy
...
Will reflect on feedback, particularly as it relates to ways to access help, active learning opportunities, and clarity in grading. 
...
### Assignments
- Assignment #3 due November 9, 11:59pm

--

.large[.red[**Important announcement: starting immediately, all classes will meet in Lokey 276 and all labs will meet in Lokey 115!**]]