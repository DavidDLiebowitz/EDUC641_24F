...
- LSWR Chapter 12: categorical data analysis (chi-square test focus)
    + Please do not worry about fully understanding the discussions on sampling distributions, degrees of freedom, one- vs. two-sided tests, or variations of chi-squared calculations. We will (partially) cover these topics in future classes.
- Levy (2019)
