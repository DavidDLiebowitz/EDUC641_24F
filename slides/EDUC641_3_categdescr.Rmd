...
1. Understand and implement principles of tabular data in R
...
```{r, echo= T}
d <- read.csv('C:/Users/daviddl/Documents/EDUC/641/data/deathpenalty.csv')
...
```{r, echo=T, fig.height=4}
rd <- ggplot2::ggplot(df, aes(rdefend)) + geom_bar() +
...
### Optional follow-up
- Complete R Bootcamp Module 5 (vectors)
- Complete R Bootcamp Module 9 (importing data)
- Complete R Bootcamp Module 11 (graphing)
- Complete R Bootcamp Module 12 (projects)
