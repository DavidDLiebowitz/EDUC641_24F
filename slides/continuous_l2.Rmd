...
$$ t = \frac{0}{SE} = 0 $$
Our standard error refers to the $\sigma$ for the sampling distribution of the **difference in means**. This is more complicated to calculate.
---
...
Just like with our one-sample t-test, every time we sample each population, we obtain a new estimated difference between the two groups. The estimated difference in means forms its own normal distribution.
...
Our standard error of the difference in mean $(\sigma_D)$ is calculated from our pooled standard deviation $(\hat{\sigma}_D)$ and sample sizes.

$$SE(\sigma_D) = \sqrt{\frac{\hat{\sigma}^2}{n_1} + \frac{\hat{\sigma}^2}{n_2}} $$
